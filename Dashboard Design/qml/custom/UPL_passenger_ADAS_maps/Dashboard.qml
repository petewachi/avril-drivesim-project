...
Item {
    ...
    property var qml_properties__RTDB_variables:
        ({
             ...
             solver_status:                 "VI_DriveSim.Outputs.Vicrt.Status", //0: undefined, 1:solver is running, 2: solver finished the simulation and waits stop request, 3: solver is paused
...
//             lap_time_best:                 "",
             ...
             adas_erv_detected:             "ADAS.Outputs.Generic.ERV_Detected" ,
...
//             tsr_speed:                     "ADAS.Outputs.KONRAD.Mobileye.speed_limit",
    ...
    height: 1080                             //uncomment  for editing in Qt Design Studio
    ...
    property double solver_status: 0        //default 0
    ...
    property bool adas_erv_detected: false
    //TSR traffic sign recognition
    ...
    property bool hands_on_alert: ldw_on || adas_error || adas_erv_detected      //to be updated to actual algorithm
    ...
    onTcs_activityChanged: {  //customed
        if (root.solver_status === 1){
            messages_item.rectangle_border = dashboard_Utils.vi_dark_grey
            if (root.tcs_activity){
                messages_item.message_value = "Traction Control engaged"
                messages_item.message_action_value = "TAKE STEER CONTROL!"
            }else{
                if (root.abs_activity){
                    messages_item.message_value = "Auto-Pilot disengaged"
                    messages_item.message_action_value = "TAKE STEER CONTROL!"
                }else{
                    messages_item.message_value = "Normal Driving Mode"
                    messages_item.message_action_value = "Pay attention to surroundings"
                }
            }
        }
    }
    ...
    Item{
        ...
        Simple_navigator_modified{
            ...
            anchors.horizontalCenterOffset: root.width/2-width/2+10
            anchors.verticalCenter: parent.verticalCenter
            anchors.verticalCenterOffset: 1
            disable_home_button: true
        }
        Speedometer_flat_component {
            id: speed_item
            visible: true
            anchors.horizontalCenter: parent.horizontalCenter
            anchors.horizontalCenterOffset: 0
            anchors.verticalCenter: lights_item.bottom
        ...
        Dashboard_Lights {
            ...
            anchors.horizontalCenter: parent.horizontalCenter
            anchors.verticalCenter: parent.verticalCenter
            anchors.verticalCenterOffset: -(root.height/2-height/2-20)
            anchors.horizontalCenterOffset: 0
        ...
        Image{
            ...
            visible: dashboard_Utils.update_visibility_on_solver_status(root.solver_status, root.hands_on_alert)
            anchors.verticalCenter: steering_wheel_widget.verticalCenter
            anchors.horizontalCenter: steering_wheel_widget.horizontalCenter
            scale: 0.25
            // rotation is in degrees
            rotation: -dashboard_Utils.rad2deg(root.steering_input)
            antialiasing: true
            mipmap: true
        ...
        Traffic_sign_widget {
            ...
            Laptime_item{
                ...
                anchors.horizontalCenterOffset: -658
                anchors.horizontalCenter: parent.horizontalCenter
            }
            ...
            GG_diagram{
                ...
                anchors.horizontalCenter: simple_navigator_modified.horizontalCenter
            ...
            Cueing_status_limits{
                ...
                anchors.verticalCenterOffset: 365
                anchors.horizontalCenterOffset: 721
                anchors.horizontalCenter: parent.horizontalCenter
            }
            ...
            Image {
                ...
                mipmap: true
                scale: 0.474
                anchors.verticalCenterOffset: root.height/2-50
                anchors.horizontalCenterOffset: -(root.width/2-135)
                anchors.horizontalCenter: parent.horizontalCenter
                fillMode: Image.PreserveAspectFit
            }
    ...
    state: "passenger_ADAS" //root.folder_path[root.folder_path.length-2]
    states: [
        State {
            name: "passenger"
